...
#### Dataset snapshot
- 15,734 cleaned listings, 71 features  
- Target = `price_class`  
- Medium price range is the largest group  
- Price goes up with room type, location, and capacity  

#### Exploratory Analysis:  
1. Price Class Distribution
```{r fig.align='center', fig.width=7, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE}
library(patchwork)
library(corrplot)
library(ggplot2)
library(tidyverse)
...
<div style="display:flex; justify-content:space-between; gap:20px;">
  <div style="width:50%;">
2.Room Type vs Price Class
  <h4 style="text-align:left; margin-top:0;">
```{r fig.align='left', fig.width=7.5, fig.height=4.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<div style="width:50%;">
3.Top 10 Neighborhoods vs Price Class
<h4 style="text-align:right; margin-top:0;">
```{r fig.align='right', fig.width=7.5, fig.height=4.5, echo=FALSE, message=FALSE, warning=FALSE}
...
<br> 
Insights:  
• Entire homes dominate high price range.  
• Private rooms cluster in low price range.  
• High-end suburbs (Manly, Waverley) show more high-price listings.  
---
#### Exploratory Analysis:  
<div style="display:flex; justify-content:space-between; gap:20px;">
<div style="width:40%;">
4.Accommodates vs Price Class
<h4 style="text-align:left; margin-top:0;">

```{r fig.align='left', fig.width=10, fig.height=5, echo=FALSE, message=FALSE, warning=FALSE}
...
<div style="width:58%;">
5.Correlation Heatmap of Top 12 Numerical Features
<h4 style="text-align:right; margin-top:0;">
```{r fig.align='right', fig.width=18, fig.height=11, out.width='100%', echo=FALSE, message=FALSE, warning=FALSE}
df <- df %>% 
...
<br> 
Key Patterns:  
• Price ↑ as accommodation capacity ↑.  
• Strong correlations among size-related features.  
• Location variables less influential numerically.  
---
class: incremental
#5️⃣ Models Used & Why
...
#
results <- data.frame(
  Model = c("LDA", "Logistic Regression", "KNN", "SVM (RBF Kernel)", "Random Forest"),
  Accuracy = c(0.574, 0.602, 0.635, 0.701, 0.728),
  Precision = c(0.56, 0.61, 0.64, 0.72, 0.74),
  Recall = c(0.57, 0.60, 0.63, 0.69, 0.72),
  F1_Score = c(0.55, 0.59, 0.62, 0.70, 0.71),
  MCC = c(NA, 0.46, 0.51, 0.58, NA)
)

kable(results, "html", digits = 3,
      caption = "Table 1: Model Performance Summary (Extracted from Final Report)") %>%
  kable_styling(full_width = FALSE, position = "center",
                bootstrap_options = c("striped", "hover", "condensed")) %>%
  row_spec(5, bold = TRUE, color = "white", background = "#66b3ff") %>%   # 高亮 Random Forest
