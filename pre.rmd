...
<div style="display:flex; justify-content:space-between; gap:20px;">
  <!-- 左上：Price Class Distribution -->
  <div style="width:48%;">
  <h4 style="text-align:left; margin-top:0;">
2. Room Type vs Price Class
```{r fig.align='left', fig.width=7, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
```
  ...
  <!-- 右上：Room Type vs Price Class -->
<div style="width:48%;">
<h4 style="text-align:right; margin-top:0;">
3.Top 10 Neighbourhoods vs Price Class
```{r fig.align='right', fig.width=7, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE}
...
<div style="width:48%;">
<h4 style="text-align:right; margin-top:0;">
5.Top 10 Neighbourhoods vs Price Class
```{r fig.align='right', fig.width=9, fig.height=6, echo=FALSE, message=FALSE, warning=FALSE}
